...
var pastebin = new Pastebin({
	"api_dev_key": "3f189943c4fc3c0d609b6e9db2a00cc6",
	"api_user_name": "SpammyHCBot",
	"api_user_password": "123!stamSTAM."
});
...
function main(session, bot, cmd, args, nick, text, time, isAdmin, trip)
{
	...
	whois.lookup(args[0], function(err, result)
	{
		...
		{
			session.sendMessage("Analytic WHOIS of " + args[0] + " can be found on: http://pastebin.com/" + data);
		}).fail(function(err)
		{
